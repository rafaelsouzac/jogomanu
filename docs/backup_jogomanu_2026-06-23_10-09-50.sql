...
CREATE TABLE `perguntas` (
  ...
  KEY `fk_perg_local_idx` (`fk_localdeorigem`),
  KEY `fk_perguntas_disciplinas1_idx` (`fk_disciplina`),
  CONSTRAINT `fk_perg_local` FOREIGN KEY (`fk_localdeorigem`) REFERENCES `locaisdeorigem` (`idlocaldeorigem`),
...
-- Dump completed on 2026-06-23 10:09:51
