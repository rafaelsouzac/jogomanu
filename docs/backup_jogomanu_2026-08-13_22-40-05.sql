...
INSERT INTO `conteudos` VALUES (2,'Algebra - Multiplos','explicação multiplos',6,'',NULL),(4,'Livro 2 - Pontuação','Reticências, Aspas, Parênteses, Dois Pontos - Pág. 13, 14, 15 e 16',7,'0',NULL),(5,'Livro 2 - Ortografia','Traz, trás, atrás e detrás - Pág. 17, 18 e 19',7,'0',NULL),(6,'Livro 2 - Ortografia','Interpretação, Pontuação e Ortografia - Pág. 21, 22, 23 e 24',7,'0',NULL),(7,'Livro 2 - Elementos da  Comunicação','Pág. 144 até 152',7,'0',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=429 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=503 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-08-13 22:40:08
