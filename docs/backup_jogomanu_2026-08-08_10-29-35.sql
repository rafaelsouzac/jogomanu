...
INSERT INTO `conteudos` VALUES (2,'Algebra - Multiplos','explicação multiplos',6,''),(4,'Livro 2 - Pontuação','Reticências, Aspas, Parênteses, Dois Pontos - Pág. 13, 14, 15 e 16',7,'0'),(5,'Livro 2 - Ortografia','Traz, trás, atrás e detrás - Pág. 17, 18 e 19',7,'0'),(6,'Livro 2 - Ortografia','Interpretação, Pontuação e Ortografia - Pág. 21, 22, 23 e 24',7,'0'),(7,'Livro 2 - Elementos da  Comunicação','Pág. 144 até 152',7,'0');
...
INSERT INTO `gabaritos` VALUES (157,103,4,13),(158,103,5,13),(159,104,4,NULL),(160,104,5,NULL),(161,105,4,NULL),(162,105,5,19),(163,106,4,13),(164,106,5,19),(165,107,4,13),(166,107,5,19),(167,108,4,NULL),(168,108,5,19),(169,109,4,13),(170,109,5,19),(171,110,4,13),(172,110,5,19),(173,111,4,13),(174,111,5,19),(175,112,4,13),(176,112,5,19),(177,113,4,13),(178,113,5,19),(179,114,4,13),(180,114,5,17),(181,115,4,13),(182,115,5,19),(183,116,4,NULL),(184,116,5,NULL),(185,117,4,NULL),(186,117,5,NULL);
...
INSERT INTO `perguntas` VALUES (4,'Qual das alternativas contém somente multiplos de 6','0',2),(5,'Qual das alternativas contém somente multiplos de 16','0',2),(84,'Qual é o traço visual mais característico do personagem Menino Maluquinho?','0',7),(85,'Segundo o texto da página, o Menino Maluquinho convidou seus amigos para uma aventura de:','0',7),(86,'Na página apresentada, o Menino Maluquinho chega em qual lugar?','0',7),(87,'Quem é chamado pelo Menino Maluquinho quando ele chega?','0',7),(88,'Qual elemento visual mostra que o Menino Maluquinho está falando?','0',7),(89,'Que tipo de balão aparece sobre a mãe do Menino Maluquinho?','0',7),(90,'As gotas desenhadas ao lado do rosto da mãe indicam:','0',7),(91,'Os traços desenhados ao redor do Menino Maluquinho no segundo quadrinho representam:','0',7),(92,'O balão acima da mãe mostra que ela está:','0',7),(93,'Pelos quadrinhos, é possível concluir que o Menino Maluquinho é uma criança:','0',7);
...
/*!50003 DROP PROCEDURE IF EXISTS `bkp_usp_cadastro_pergunta_respostas` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `bkp_usp_cadastro_pergunta_respostas`(
...
BEGIN
    ...
    SET @enunciado = 'ação para aparecer';
    -- SET @enunciado = JSON_VALUE(p_json_pergunta, '$.enunciado');
    SET @temimagem = JSON_VALUE(p_json_pergunta, '$.temimagem');
    SET @fk_conteudo = CAST(JSON_VALUE(p_json_pergunta, '$.fk_conteudo') AS UNSIGNED);    
	
    -- 2. Insere a pergunta principal
    INSERT INTO perguntas (enunciado, temimagem, fk_conteudo)
    VALUES (@enunciado, @temimagem, @fk_conteudo);
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `teste_json` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_general_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `teste_json`(
    IN p_json LONGTEXT
)
BEGIN
	DECLARE par_json varchar(1020);
    
    SET par_json = JSON_EXTRACT(
                p_json,
                '$.enunciado'
            );
...
-- Dump completed on 2026-08-08 10:29:40
