...
INSERT INTO `perguntas` VALUES (4,'Qual das alternativas contém somente multiplos de 6','0',2,NULL),(84,'Qual é o traço visual mais característico do personagem Menino Maluquinho?','0',7,NULL),(85,'Segundo o texto da página, o Menino Maluquinho convidou seus amigos para uma aventura de:','0',7,NULL),(86,'Na página apresentada, o Menino Maluquinho chega em qual lugar?','0',7,NULL),(87,'Quem é chamado pelo Menino Maluquinho quando ele chega?','0',7,NULL),(88,'Qual elemento visual mostra que o Menino Maluquinho está falando?','0',7,NULL),(89,'Que tipo de balão aparece sobre a mãe do Menino Maluquinho?','0',7,NULL),(90,'As gotas desenhadas ao lado do rosto da mãe indicam:','0',7,NULL),(91,'Os traços desenhados ao redor do Menino Maluquinho no segundo quadrinho representam:','0',7,NULL),(92,'O balão acima da mãe mostra que ela está:','0',7,NULL),(93,'Pelos quadrinhos, é possível concluir que o Menino Maluquinho é uma criança:','0',7,NULL),(108,'Conforme as regras de ortografia da língua portuguesa, qual das alternativas preenche corretamente as lacunas da frase a seguir: \"Ela sempre ___ ótimas notícias quando vem nos visitar, mas prefere sentar na parte de ___ para não chamar atenção.\"?','0',5,''),(109,'Analise o uso dos vocábulos e assinale a alternativa que preenche de forma correta e gramaticalmente adequada as lacunas do texto: \"O menino correu para ___ da árvore, pois percebeu que o cão vinha logo ___ dele.\"','0',5,''),(110,'Observe a frase: \"Não olhe para ___, mantenha seu foco no caminho e lembre-se de que cada esforço ___ bons resultados.\" Qual opção completa as lacunas com a ortografia correta?','0',5,''),(111,'Assinale a alternativa em que o emprego do termo destacado preenche corretamente a frase: \"Quem vem por ___ do muro não percebe a pessoa que ficou ___ do carro e o dinheiro que ele ___ no bolso.\"','0',5,''),(112,'Indique a opção que completa corretamente a lacuna do enunciado a seguir: \"A educação ___ benefícios duradouros para toda a sociedade, mesmo que os resultados fiquem ocultos por ___ das dificuldades iniciais.\"','0',5,''),(113,'Assinale a alternativa que apresenta a sequência correta para preencher as lacunas: \"Ele olhou para ___ antes de atravessar a rua, pois sabia que o carro vinha logo ___ da van e isso sempre ___ perigo para os pedestres.\"','0',5,''),(114,'Qual das opções completa corretamente a frase: \"Ela deixou a bolsa de ___ do balcão e correu para ___ da fila, esperando que o atendente lhe trouxesse o documento que ___ a solução do problema.\"?','0',5,''),(115,'Assinale a opção em que todas as lacunas da frase estão preenchidas de forma ortograficamente correta: \"O motorista que vem ___ do ônibus não percebeu a placa de sinalização que a tempestade ___ consigo.\"','0',5,''),(116,'Conforme o uso correto da pontuação na língua portuguesa, assinale a alternativa que preenche corretamente a lacuna na frase a seguir: \"Juliana foi à feira e comprou vários itens ___ maçãs, bananas, laranjas e morangos.\"','0',4,''),(117,'Analise a estrutura sintática da frase: \"O diretor anunciou a decisão ___ A reunião será adiada para a próxima semana.\" Qual sinal de pontuação deve substituir os três underlines ___ para introduzir a declaração do diretor?','0',4,''),(118,'Assinale a alternativa que explica corretamente a função dos dois pontos na frase: \"Ele tinha apenas um desejo ___ passar no exame final.\"','0',4,''),(119,'Na frase \"O autor afirmou no capítulo 2 ___ A leitura transforma o mundo ___ e encerrou a palestra\", os dois espaços indicados por ___ devem ser preenchidos por qual sinal de pontuação para indicar uma citação textual?','0',4,''),(120,'Considere a frase: \"Eu estava pensando se deveríamos ir até lá ___ mas talvez seja melhor esperar até amanhã.\" Qual sinal de pontuação no espaço ___ expressa adequadamente a ideia de hesitação ou suspensão do pensamento?','0',4,''),(121,'Na frase \"A Segunda Guerra Mundial ___ 1939-1945 ___ causou transformações profundas na história da humanidade\", qual sinal deve ser utilizado nos espaços de três underlines ___ para inserir essa informação explicativa sobre as datas?','0',4,'');
...
-- Dump completed on 2026-08-19 18:10:01
